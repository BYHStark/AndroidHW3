...
public class Fragment_news extends Fragment {
    ...
    private void initItemContent() {
        ItemNews kola1 = new ItemNews("Running",R.drawable.level_base,"Running is an Attitude");
        ItemNews kola2 = new ItemNews("Swimming",R.drawable.level_acme,"Become Thinner");
        ItemNews kola3 = new ItemNews("Basketball",R.drawable.level_enhance,"Burn my calorie");
        ItemNews kola4 = new ItemNews("Badminton",R.drawable.level_badminton,"Shuttlexcock");
